...
เราสามารถทำได้โดยหาขอบเขตของความน่าจะเป็นที่จะมี hypothesis อย่างน้อยตัวหนึ่งใน $H$ ที่ี error มากกว่า $\epsilon$
...
อย่างไรก็ดี เราไม่สามารถจำกัดขอบเขตของความน่าจะเป็นดังกล่าวนี้โดยใช้ union bound เหมือนในกรณีที่ $H$
มีขนาดจำกัดได้
