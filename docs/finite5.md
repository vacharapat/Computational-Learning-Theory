...
สังเกตว่าเมื่อ $r=1$ $T$ นั้นมีโครงสร้างเป็น 1-decision list อยู่แล้ว เราสามารถสร้าง $L$ ได้โดยการเลือก literal
ของตัวแปร $x_i$ ที่อยู่ในแต่ละ node ใน $T$ ให้สอดคล้องกับทิศทางของ leaf node ที่เป็นลูกของ $x_i$
กล่าวอย่างชัดเจนคือ เราสามารถสร้าง $L$ ได้โดยพิจารณาที่ root ของ $T$ ให้ $x_T$ เป็นตัวแปรที่ label อยู่ที่ root ของ $T$
เนื่องจาก $T$ มี rank เป็น 1
แสดงว่าจะต้องมี node ลูกทางซ้ายหรือขวาของ root ที่เป็น leaf (rank เป็น 0) หากเราพบว่า node ลูกด้านซ้ายเป็น leaf ที่ label ด้วย $$b\in\{0,1\}$$ เราก็เพิ่มคู่ลำดับ $(\bar{x}_T,b)$ เป็นเงื่อนไขแรกใน $L$ หาก node ลูกด้านซ้ายไม่ใช่ leaf
แสดงว่า node ลูกด้านขวาต้องเป็น leaf เราก็เพิ่มคู่ลำดับ $(x_T,b)$ เป็นเงื่อนไขแรกใน $L$ แทน
จากนั้นเราก็วนรอบพิจารณาต้นไม้ย่อยที่มี node ลูกอีกฝั่งหนึ่งเป็น root ต่อไปจนกระทั่งเหลือต้นไม้ย่อยที่มีเพียง node เดียว
เราก็ใช้ค่า $$b\in\{0,1\}$$ ที่ label ไว้ที่ node ดังกล่าวเป็นค่า default ของ $L$
