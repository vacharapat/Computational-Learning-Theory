...
โดย hypothesis space $H$ ที่มีอัตราการโตของ $\Pi_H(m)$ สูงก็จะมีความซับซ้อนสูง หรือมีพลังในการจำแนกข้อมูลสูงกว่า
hypothesis space $H$ ที่มีอัตราการโตของ $\Pi_H(m)$ นั่นเอง
...
และหากพิจารณาเซตของตัวอย่างข้อมูลจำนวน $d_H+1$ ตัวขึ้นไป ไม่ว่าจะเป็นเซตใดก็จะไม่มีทางถูก shatter โดย $H$ ได้
