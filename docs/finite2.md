...
($size(c)<<n$) โดยในอัลกอริทึมใหม่นี้จะแตกต่างจากเดิมตรงที่เราจะนำ negative example มาพิจารณาด้วย
...
$$S=\{s_1,\dots,s_k\}$$ โดยที่ $s_i\subseteq U$ สำหรับ $i=1\dots,k$ เราต้องการเลือกเซตใน $S$
